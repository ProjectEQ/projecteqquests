function event_death_complete(e) 
	...
	if (roll >= 50) then
    eq.local_emote({e.self:GetX(), e.self:GetY(), e.self:GetZ()}, 13, 70,"You hear a loud screech as something breaks free of the stone.");
    ...
    eq.local_emote({e.self:GetX(), e.self:GetY(), e.self:GetZ()}, 13, 70,"You feel a blast of heat as you open the rock and see a dark stone inside.");
