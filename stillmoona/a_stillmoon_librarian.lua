function event_say(e)
	if(e.message:findi("hail")) then
		...
		eq.unique_spawn2(338407, 0, 0, -729, 1097, 5, 123);
		eq.unique_spawn2(338408, 0, 0, -704, 1141, 5, 252);
		eq.unique_spawn2(338409, 0, 0, -733, 1106, 5, 123);
		eq.unique_spawn2(338410, 0, 0, -703, 1063, 5, 510);
	end
end
