function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings and salutations $name. I am Miltiades Tal`Azroth Crusader of Karana. I have spent all of my years here in Qeynos and gathered infinite knowledge from my teachers on my path to enlightenment. I have also started training new recruits to help them find their calling as a Holy Warrior of Karana. If you are a [Paladin of Karana] I might have some tasks for you to complete.");
	elseif(e.message:findi("paladin of karana")) then
		e.self:Say("That is excellent news $name. As a Knight in training of Karana I would like to offer you a series of [tests] what will test your devotion to yourself and your god.");
	...
	elseif(e.message:findi("fashioning your materials")) then
		e.self:Say("Excellent $name. Please take this Rainkeepers Assembly Kit. Now for your materials you will fashion you will obviously need to know what items are used for what armor materials. Simply tell me what armor piece you [want] to create and I will present you with the recipe for that specific armor material. I can present you with the molds and recipes necessary for creating Rainkeeper [Helm], [Bracers], [Armguards], [Boots], [Greaves], [Gauntlets] and [Breastplate].");
