...
if($text=~/aid the cause/i && $pov_key_quest == 1) {
...
if($text=~/Aerin`Dar/i && $pov_key_quest == 1) {
...
if($text=~/hail/i && $pov_key_quest == 3) {
...
if($text=~/company/i && $pov_key_quest == 3) {
...
if($text=~/mission/i && $pov_key_quest == 3) {
