...
sub EVENT_SAY {
   ...
   if($text=~/Hail/i && $sirran == 1) { #island1
   ...
   elsif($text=~/traverse this plane/i && $sirran == 1) {
   ...
   elsif($text=~/Hail/i && $sirran == 2) { #island2
   ...
   elsif($text=~/Hail/i && $sirran == 3) { #island3
   ...
   elsif($text=~/Hail/i && $sirran == 4) { #island4
   ...
   elsif($text=~/Hail/i && $sirran == 5) { #island5
   ...
   elsif($text=~/citanuL eht narriS, liaH/i && $sirran == 6) { #island6

      quest::say("Lortap llaw taerg eht fo lahsram, Narris lahsram ma I. Flesym ecudortni ot em wolla. Sgniteerg");

      }

   elsif( $text =~ /llaw eht htiw eno I ma/i && $sirran == 6) { #island6
      ...
      #x,y,z of her spawn needs to be tuned to match live more closely

      }
   elsif($text=~/Hail/i && $sirran == 7) { #island7
