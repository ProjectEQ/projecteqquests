...
function event_trade(e)
	...
	local qglobals = eq.get_qglobals(e.other);
	if(qglobals["warrior_epic"] ~= nil and qglobals["warrior_epic"] >= "2" and item_lib.check_turn_in(e.trade, {item1 = 60295, item2 = 60296, item3 = 60297, item4 = 60298}) ) then --Decomposing Page 1,2,3 and Decomposing Cover (returned during last step)
