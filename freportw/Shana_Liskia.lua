...
function event_trade(e)
	...
	elseif(e.other:HasItem(62846) and e.other:HasItem(62850) and item_lib.check_turn_in(e.trade, {item1 = 62852,item2 = 62852,item3 = 62852})) then -- 3x Crystal Fragment, has Mind Crystal and Protected Living Brambles Seed
