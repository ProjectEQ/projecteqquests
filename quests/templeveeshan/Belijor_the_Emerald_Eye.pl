...
sub EVENT_AGGRO {
  my $guard1 = $entity_list->GetMobByNpcTypeID(124089); #nelaarn
  my $guard2 = $entity_list->GetMobByNpcTypeID(124088); #ajroek
...
# EOF zone: templeveeshan ID: 124057 NPC: Belijor_the_Emerald_Eye
