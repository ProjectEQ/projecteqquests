...
sub EVENT_SAY {
  ...
  if(($text=~/hail/i) && (!defined $qglobals{wizepicA}) && (!defined $qglobals{wizepicB})) {
...
sub EVENT_ITEM {
  ...
  elsif ((defined $qglobals{wizepicB}) &&  plugin::check_handin(\%itemcount, 14337 => 1, 14338 => 1, 14339 => 1)){
