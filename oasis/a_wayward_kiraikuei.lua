...
function event_trade(e)
	...
	if(qglobals["Fatestealer"] == "1" and item_lib.check_turn_in(e.trade, {item1 = 9599 })) then
      ...
      local request = instance_requests.ValidateRaidRequest("hateplaneb", 1, 1, 36, 61, nil, e.other, lockout_globals);
      ...
      elseif (request.valid and request.flags == 0) then
        local raid = e.other:GetRaid();
        local instance_id = eq.create_instance("hateplaneb", 1, 3600); --FIXME TO 3600
