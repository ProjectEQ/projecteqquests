...
function event_say(e)
	...
	if(e.message:findi("elder spirit sent me") and qglobals["shaman_epic"] == "1") then
		...
		eq.spawn2(117091,0,0,1048,353,-39,128) --Gnashing_Killer_Shark
		eq.spawn2(117089,0,0,1038,353,-39,128) --Darting_Shark
		eq.spawn2(117090,0,0,1058,353,-39,128) --Feeder_Shark
	end
end
