...
function event_trade(e)
	...
	local item_lib = require("items");
		if (e.other:GetFaction(e.self) <= 2 or e.other:GetGM() and (class == "Warrior" or class == "Paladin" or class == "Shadowknight" or class == "Bard" or class == "Monk" or class == "Beastlord" or class == "Berserker" or class == "Ranger" or class == "Rogue" or e.other:GetGM())) then -- require warmly and melee
			...
			if(item_lib.check_turn_in(e.trade, {item1 = 36504,item2 = 36505,item3 = 36506,item4 = 36507})) then -- Makyahs Statue quest
				...
				e.other:Faction(410,5) --Dranik Loyalists +5
		...
		elseif (e.other:GetFaction(e.self) <= 2 or e.other:GetGM() and (class == "Magician" or class == "Wizard" or class == "Enchanter" or class == "Cleric" or class == "Druid" or class == "Shaman" or class == "Necromancer" or e.other:GetGM())) then -- require warmly and caster
			if(item_lib.check_turn_in(e.trade, {item1 = 36504,item2 = 36505,item3 = 36506,item4 = 36507})) then -- Makyahs Statue quest
				e.self:Say("Can it be? You've found it! I shall have this pieced together where no Muramite can find it again. It will be an inspiration for the coming generations and a beacon of hope in these times of darkness. Here take this mask. May it help you always to see the light and protect you from the trials of darkness.");
