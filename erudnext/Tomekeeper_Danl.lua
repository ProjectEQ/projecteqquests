function event_say(e)
	if(e.other:GetLevel() >= 46 and e.other:Class() == "Monk") then
		...
		elseif(qglobals["monk_epic"] >= "2" and e.message:findi("power of the immortals")) then
		...
		elseif(qglobals["monk_epic"] >= "3" and e.message:findi("disciple of Kaiaren")) then 
		...
		elseif(qglobals["monk_epic"] >= "3" and e.message:findi("vortix")) then
		...
		elseif(qglobals["monk_epic"] >= "3" and e.message:findi("book")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 18195}) and e.other:GetLevel() >= 46 and e.other:Class() == "Monk") then
		...
		e.other:Ding();
	elseif(qglobals["monk_epic"] >= "2" and item_lib.check_turn_in(e.trade, {item1 = 48132})) then
