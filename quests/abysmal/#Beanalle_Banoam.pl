sub EVENT_SAY {
  if(($text=~/hail/i) && (defined $qglobals{bic} && $qglobals{bic} == 18)) {
  ...
  if(($text=~/discovered/i) && (defined $qglobals{bic} && $qglobals{bic} == 18)) {
  ...
  if(($text=~/matter/i) && (defined $qglobals{bic} && $qglobals{bic} == 18)) {
  ...
  if(($text=~/drawback/i) && (defined $qglobals{bic} && $qglobals{bic} == 18)) {
  ...
  if(($text=~/item/i) && (defined $qglobals{bic} && $qglobals{bic} == 18)) {
  ...
  if(($text=~/yes/i) && (defined $qglobals{bic} && $qglobals{bic} == 18)) {
