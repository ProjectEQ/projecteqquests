...
function event_say(e)
	if(e.message:findi("hail")) then -- Part of Shaman Epic 1.0
		e.self:Emote("turns his head slowly toward you but his eyes never come into focus. You can't tell if he's looking at you, behind you, or right in front of his own face. Then, suddenly, he shouts at the top of his lungs, 'HOOOOKAAAHEEEEYYYY! I AM [" .. eq.say_link("ABE") .. "]!");
	elseif(e.message:findi("Abe")) then -- Part of Shaman Epic 1.0
		e.self:Say("Nothing is hidden. All is discernible if you only know where to look and you have the right [" .. eq.say_link("eyes") .. "]. Don't be angry with me if you can't get your eyes right to see what you're looking for. I'd lend you mine but I don't wear the same size.");
	elseif(e.message:findi("eyes")) then -- Part of Shaman Epic 1.0
		e.self:Emote("begins to draw a picture in the mud with his finger although it doesn't seem to make any sense at all. He points to his picture and nods approvingly at you, saying, 'You see? The curtains fell and it was naught but a dream upon a landscape that we thought we knew. The dream of the [" .. eq.say_link("combine") .. "] fulfilled when we finally trimmed our fingernails and looked into the mud. And now we are abandoned, in a world that none can see, no one has the eyes.");
...
function event_timer(e)
	...
	if (counting == 1) then
		e.self:Say("Shaman? My time will soon be at hand and I fear I will never see our friends again. But the arrow must be given, our holy broken arrow. Shaman, will you bear our obligation and [" .. eq.say_link("give them the arrow") .. "]? You will know who to give it to when it is time.");
