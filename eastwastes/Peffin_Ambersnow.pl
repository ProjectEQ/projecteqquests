...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 18171 => 1)) { #letter to peffin
    quest::spawn2(116182,0,0,3364,-1579,163.8,71.6); # NPC: Kromrif_Elite
    quest::spawn2(116182,0,0,3314,-1557,163.8,84.8); # NPC: Kromrif_Elite
    quest::spawn2(116182,0,0,3355,-1625,163.8,73.8); # NPC: Kromrif_Elite
    quest::settimer(1,10);
...
sub EVENT_TIMER {
  if($timer == 1) {
    quest::stoptimer(1);
    quest::spawn2(116574,0,0,3419.4,-1739.7,143.9,383); # NPC: #Peffin_Ambersnow
