function event_click_door(e)
  ...
  if (door_id == 2) then
    ...
    if (instance_id ~= nil and instance_id ~= 0) then
      e.self:MovePCInstance(304, instance_id, 0, -37, .3, 508);
    else
  ...
  elseif (door_id == 3) then
    ...
    if (instance_id ~= nil and instance_id ~= 0) then
      e.self:MovePCInstance(309, instance_id, 0, -37, .3, 508);
    else
      e.self:Message(13, "You are not part of an instance.");
    end
  ...
  elseif (door_id == 5) then
    ...
    if (instance_id ~= nil and instance_id ~= 0) then
      e.self:MovePCInstance(305, instance_id, 0, -37, .3, 508);
    else
      e.self:Message(13, "You are not part of an instance.");
    end
  ...
  elseif (door_id == 7) then
    ...
    if (instance_id ~= nil and instance_id ~= 0) then
      e.self:MovePCInstance(306, instance_id, 0, -37, .3, 508);
    else
      e.self:Message(13, "You are not part of an instance.");
    end
  ...
  elseif (door_id == 4) then
    ...
    if (instance_id ~= nil and instance_id ~= 0) then
      e.self:MovePCInstance(307, instance_id, 0, -37, .3, 508);
    else
      e.self:Message(13, "You are not part of an instance.");
    end
  ...
  elseif (door_id == 6) then
    ...
    if (instance_id ~= nil and instance_id ~= 0) then
      e.self:MovePCInstance(308, instance_id, 0, -37, .3, 508);
    else
      e.self:Message(13, "You are not part of an instance.");
    end
