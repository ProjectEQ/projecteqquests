...
function event_say(e)
  ...
  elseif (e.message:findi("Subversion")) then
    ...
    e.other:CreateExpedition(subversion.dz, subversion.info)
  elseif (e.message:findi("Foresight")) then
    ...
    e.other:CreateExpedition(foresight.dz, foresight.info)
