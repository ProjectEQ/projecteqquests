...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 9031 => 1)) { #Item: Official Seal of the Khati Sha
    ...
    quest::unique_spawn(73107, 0, 0, -275, 700, -38); #NPC: The Icebound Spirit
    quest::summonitem(9031); #Item: Official Seal of the Khati Sha
  }
  elsif (plugin::check_handin(\%itemcount, 9036 => 1)) { #Item: Totem of the Ice Bear
