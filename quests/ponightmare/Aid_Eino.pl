...
sub EVENT_ITEM {
  if (($x == 1690) && ($y == 285) && plugin::check_handin(\%itemcount, 16261 => 1)) {
    quest::say("Excellent work. Thank you for your help. Here, take this. I must get back to the Plane of Knowledge. Come and see me when you get a chance.");
