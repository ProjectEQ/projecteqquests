...
sub EVENT_SAY { 
    ...
    if ($text=~/important components/i) { 
      ...
      quest::summonitem(61094); # Item: Craft Keepers Assembly Kit 
    } 
    if ($text=~/bracer/i) { 
      ...
      quest::summonitem(22584); # Item: Enchanted Bracer Pattern 
    } 
    if ($text=~/cap/i) { 
      ...
      quest::summonitem(22583); # Item: Enchanted Cap Pattern 
    } 
    if ($text=~/gloves/i) { 
      ...
      quest::summonitem(22633); # Item: Enchanted Gloves Pattern 
    } 
    if ($text=~/sandals/i) { 
      ...
      quest::summonitem(22585); # Item: Enchanted Sandals Pattern 
    }
    if ($text=~/sleeves/i) { 
      ...
      quest::summonitem(22631); # Item: Enchanted Sleeves Pattern 
    } 
    if ($text=~/trousers/i) { 
      ...
      quest::summonitem(22632); # Item: Enchanted Trousers Pattern 
    } 
    if ($text=~/robe/i) { 
      ...
      quest::summonitem(22634); # Item: Enchanted Robe Pattern 
    } 
...
sub EVENT_ITEM { 
    if (plugin::check_handin(\%itemcount, 19552 => 1, 19659 => 1, 13424 => 1, 63125 => 1)) { # dagger of the craft keeper 
      quest::summonitem(61099); # Item: Dagger of the Craft Keeper 
