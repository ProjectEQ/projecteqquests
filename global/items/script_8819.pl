...
sub EVENT_ITEM_CLICK {
	if($zonesn eq 'nektulos') {
		if(quest::istaskactivityactive(3540,0)) {
			my $x_loc = 1035;
			my $y_loc = -1110;
			WAYPOINT_LOCATION($x_loc, $y_loc);
		}
		elsif(quest::istaskactivityactive(3540,1)) {
			my $x_loc = -890;
			my $y_loc = -1910;
			WAYPOINT_LOCATION($x_loc, $y_loc);
		}
		elsif(quest::istaskactivityactive(3540,2)) {
			my $x_loc = 25;
			my $y_loc = -1195;
			WAYPOINT_LOCATION($x_loc, $y_loc);
		}
		elsif(quest::istaskactivityactive(3540,3)) {
			my $x_loc = 1045;
			my $y_loc = -505;
			WAYPOINT_LOCATION($x_loc, $y_loc);
		}
		elsif(quest::istaskactivityactive(3540,4)) {
			my $x_loc = 530;
			my $y_loc = 890;
			WAYPOINT_LOCATION($x_loc, $y_loc);			
		}
		elsif(quest::istaskactivityactive(3540,5)) {
			my $x_loc = -530;
			my $y_loc = -865;
			WAYPOINT_LOCATION($x_loc, $y_loc);
		}
		elsif(quest::istaskactivityactive(3540,6)) {
			my $x_loc = -760;
			my $y_loc = 0;
			WAYPOINT_LOCATION($x_loc, $y_loc);
		}
		elsif(quest::istaskactivityactive(3540,7)) {
			my $x_loc = -75;
			my $y_loc = 860;
			WAYPOINT_LOCATION($x_loc, $y_loc);
		}
		elsif(quest::istaskactivityactive(3540,8)) {
			my $x_loc = 700;
			my $y_loc = 1685;
			WAYPOINT_LOCATION($x_loc, $y_loc);
		}
		elsif(quest::istaskactivityactive(3540,9)) {
			my $x_loc = -950;
			my $y_loc = 1820;
			WAYPOINT_LOCATION($x_loc, $y_loc);
		}
