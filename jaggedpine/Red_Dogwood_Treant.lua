...
function event_timer(e)
	...
	elseif(e.timer=="e2") then
		eq.stop_timer("e2");
		currclient:Message(MT.Yellow,"Red Dogwood Treant speaks directly into your mind. My day of growth is a glorious one, but now that I can sense the world directly I feel a dangerous presence invading it. There is a force of chaos here, I can feel it in my limbs. I am not the only one that feels this, for I hear others thinking about it. Many of them do not know what it is, they can not understand its force, but they are reacting to it. I sense that our world is becoming more dangerous, that there is a change coming. I also feel something closer, something coming. Something knows I have become aware. It is a servant of the chaos. It... it reaches for me!");
