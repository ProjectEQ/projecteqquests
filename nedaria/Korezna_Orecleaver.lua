...
function event_trade(e)
	...
	if (qglobals["warrior_epic_korezna"] == "1" and item_lib.check_turn_in(e.trade, {item1 = 13006, item2 = 13006, item3 = 13006})) then --3x Water Flask
	...
	if (qglobals["warrior_epic_korezna"] == "2" and item_lib.check_turn_in(e.trade, {item1 = 60301, item2 = 60302})) then -- Blackfall Ore and Smelting Plans
