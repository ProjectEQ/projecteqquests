sub EVENT_SAY {
  ...
  if ($text=~/hail/i) {
    if (quest::get_data($charKey . "-RecievedInitialSoulAnchor")) {
      plugin::NPCTell("Hail, traveler. I can transport you to the Great Spires of Velious, or any of the locations that on the continent to which your soul has become attuned.");
    } else {
      plugin::NPCTell("Hail, traveler. I can transport you to the Great Spires of Velious. Speak to Magus Obine on the central spire if you would like to travel to other locations.");
    }
