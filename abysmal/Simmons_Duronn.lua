...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.self, e.trade, {item1 = 55570}) then -- Venomous Stonemite Poison Sac
	...
	elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55574}) then -- Prepared Stonemite Sac
