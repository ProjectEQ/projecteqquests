...
if (plugin::check_handin(\%itemcount, 55566 => 1, 55560 =>1)) { # Clay golem parts and workers badge - number one
...
if (plugin::check_handin(\%itemcount, 55564 => 1,55556 => 1)) { # Worker's badge - number five and Vial of anti rust agent
...
if (plugin::check_handin(\%itemcount, 55565 => 1,10503 => 3)) { # Worker's badge - number six and Block of ore
...
if (plugin::check_handin(\%itemcount, 55567 => 1, 9747 => 1,9654 =>1)) { # Worker's badge - number seven, Filleted Mammoth, Jumjum Cake
