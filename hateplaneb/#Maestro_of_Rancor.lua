...
function event_hp(e)
  if (e.hp_event == 75) then
    eq.spawn2(186191,0,0,-117.37,-477,35.88,129.2);
    eq.spawn2(186191,0,0,-117.37,-483,35.88,129.2);
  ...
  elseif (e.hp_event == 40) then
    eq.spawn2(186192,0,0,-291,-421,23.23,256);
    eq.spawn2(186193,0,0,-333,-480,23.23,129.2);
    eq.spawn2(186194,0,0,-293,-541,23.23,2);
  end
end
