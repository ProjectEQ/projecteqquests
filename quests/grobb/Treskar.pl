...
if($itemcount{12190} == 1){
  ...
  if (plugin::check_handin(\%itemcount, 13782 => 3, 10307 => 1)) {
  ...
  if (plugin::check_handin(\%itemcount, 13088 => 2)) {
  ...
  if (plugin::check_handin(\%itemcount, 13916 => 3)) {
  ...
  if (plugin::check_handin(\%itemcount, 13403 => 2, 13070 => 2)) {
