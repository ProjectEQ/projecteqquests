...
$check=0;
    ...
    if($check == 0 && $event_start == undef && $wind_done == undef) {
...
sub EVENT_SIGNAL {
     if ($signal == 1 && $event_start == 1 && $wind_done == undef) {
        $counter=0;
     ...
     if ($signal == 2 && $event_start == 1) {
        $counter+=1;
     	if ($signal == 2 && $counter == 3 && $event_start == 1 && $wind_done == undef) {
     ...
     if ($signal == 3 && $event_start == 1 && $wind_done == undef) {
           quest::depop(215057);
