...
sub EVENT_ENTER {
	...
	if($InInstanceTipt > 0){
		quest::MovePCInstance(289, $InInstanceTipt, -448, -2374, 12); # Zone: tipt
	}
	elsif($InInstanceVxed > 0){
	    	quest::MovePCInstance(290, $InInstanceVxed, -427, -3552, 14); # Zone: vxed
	}
	elsif($inInstanceVxedPally > 0){
	    	quest::MovePCInstance(290, $inInstanceVxedPally, -427, -3552, 14); # Zone: vxed
	}	
	else {
