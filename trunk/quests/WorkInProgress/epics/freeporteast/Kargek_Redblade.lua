function event_say(e)
	if(e.other:Class() == "Warrior") then
		...
		elseif(e.message:findi("Korbuk Brimblade sent me to help") and qglobals["warrior_pre"] == "3") then
		...
		elseif(e.message:findi("sword") and qglobals["warrior_pre"] == "3") then
		...
		elseif(e.message:findi("who did it") and qglobals["warrior_pre"] == "3") then	
		...
		elseif(e.message:findi("Find Drevlon") and qglobals["warrior_pre"] == "3") then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 60287}) and qglobals["warrior_pre"] == "3") then --hand in Redblade Family Sword (dropped by Drevlon Knacknabber in East Karana)
		...
		e.other:SummonItem(60288); --Emblazoned Champion's Hilt
	end	
