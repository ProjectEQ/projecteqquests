function event_spawn(e)
	eq.set_timer("nkar15min",10 * 60 *1000); -- Live like is 15 minutes
end
...
function event_timer(e)
	if e.timer == "nkar15min" then
		...
		eq.set_timer("nkar5min",2 * 60 * 1000);
