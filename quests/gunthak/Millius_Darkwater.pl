...
sub EVENT_ITEM{
  ...
  elsif ($itemcount{59028} == 1){
    quest::say("You still haven't found Chester.");
    quest::summonitem(59028); #Black Skull Necklace for male erudite spirit
  }
}
