...
sub EVENT_SAY {
  ...
  if($text=~/put my jewel craft skills to the test/i) {
  ...
  if($text=~/ready to use some clay/i) {
  ...
  if($text=~/am skilled with the needle/i) {
  ...
  if($text=~/skills with a fletching knife/i) {
