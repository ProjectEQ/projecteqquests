...
function event_hp(e)
	if (e.hp_event == 91) then
		...
		eq.spawn2(eq.ChooseRandom(223079,223081,223080,223082),0,0,-219,344,348,256);
		eq.spawn2(eq.ChooseRandom(223079,223081,223080,223082),0,0,-219,277,348,256);
		eq.spawn2(eq.ChooseRandom(223079,223081,223080,223082),0,0,-347,210,348,128);
		eq.spawn2(eq.ChooseRandom(223079,223081,223080,223082),0,0,-296,210,348,128);
