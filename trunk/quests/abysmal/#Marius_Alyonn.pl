...
if($qvichelmchange == 1 && $text=~/fee/i){
...
if($qvichelmchange == 1 && $text=~/yes/i){
...
if (plugin::check_handin(\%itemcount, 67720 => 1)) { # Dakkamor's Helm of the Divine 
...
if (plugin::check_handin(\%itemcount, 67729 => 1)) { # Gaelin's Woodland Cap 
quest::emote("Marius Alyonn pulls a small item out of his pocket places it on the floor and stands back as it starts to unfold, revealing what looks to be a modified forge. Placing the helm inside the forge, Marius pulls a small lever on the side, removes the helm from within, and hands it to you.");
quest::say("There you go! Let me know what you think. If you don't like it, you can always come back, but it will cost you. This type of technology does not come cheap you know.");  
quest::setglobal("qvichelmchange", 1, 5, "F");
...
if (plugin::check_handin(\%itemcount, 67732 => 1)) { # Jennu's Circlet of Creation 
quest::emote("Marius Alyonn pulls a small item out of his pocket places it on the floor and stands back as it starts to unfold, revealing what looks to be a modified forge. Placing the helm inside the forge, Marius pulls a small lever on the side, removes the helm from within, and hands it to you.");
quest::say("There you go! Let me know what you think. If you don't like it, you can always come back, but it will cost you. This type of technology does not come cheap you know.");  
quest::setglobal("qvichelmchange", 1, 5, "F");
...
if (plugin::check_handin(\%itemcount, 67726 => 1)) { # Kanleku's Helm of Spirits 
quest::emote("Marius Alyonn pulls a small item out of his pocket places it on the floor and stands back as it starts to unfold, revealing what looks to be a modified forge. Placing the helm inside the forge, Marius pulls a small lever on the side, removes the helm from within, and hands it to you.");
quest::say("There you go! Let me know what you think. If you don't like it, you can always come back, but it will cost you. This type of technology does not come cheap you know.");  
quest::setglobal("qvichelmchange", 1, 5, "F");
...
if (plugin::check_handin(\%itemcount, 67733 => 1)) { # Nolaen's Lifereaper Circlet 
quest::emote("Marius Alyonn pulls a small item out of his pocket places it on the floor and stands back as it starts to unfold, revealing what looks to be a modified forge. Placing the helm inside the forge, Marius pulls a small lever on the side, removes the helm from within, and hands it to you.");
quest::say("There you go! Let me know what you think. If you don't like it, you can always come back, but it will cost you. This type of technology does not come cheap you know.");  
quest::setglobal("qvichelmchange", 1, 5, "F");
...
if (plugin::check_handin(\%itemcount, 67731 => 1)) { # Nunkin's Circlet of Pure Elements 
quest::emote("Marius Alyonn pulls a small item out of his pocket places it on the floor and stands back as it starts to unfold, revealing what looks to be a modified forge. Placing the helm inside the forge, Marius pulls a small lever on the side, removes the helm from within, and hands it to you.");
quest::say("There you go! Let me know what you think. If you don't like it, you can always come back, but it will cost you. This type of technology does not come cheap you know.");  
quest::setglobal("qvichelmchange", 1, 5, "F");
...
if (plugin::check_handin(\%itemcount, 67728 => 1)) { # Pressl's Cap of Balance 
quest::emote("Marius Alyonn pulls a small item out of his pocket places it on the floor and stands back as it starts to unfold, revealing what looks to be a modified forge. Placing the helm inside the forge, Marius pulls a small lever on the side, removes the helm from within, and hands it to you.");
quest::say("There you go! Let me know what you think. If you don't like it, you can always come back, but it will cost you. This type of technology does not come cheap you know.");  
quest::setglobal("qvichelmchange", 1, 5, "F");
...
if (plugin::check_handin(\%itemcount, 67721 => 1)) { # Trimdet's Helm of Chivalry 
quest::emote("Marius Alyonn pulls a small item out of his pocket places it on the floor and stands back as it starts to unfold, revealing what looks to be a modified forge. Placing the helm inside the forge, Marius pulls a small lever on the side, removes the helm from within, and hands it to you.");
quest::say("There you go! Let me know what you think. If you don't like it, you can always come back, but it will cost you. This type of technology does not come cheap you know.");  
quest::setglobal("qvichelmchange", 1, 5, "F");
