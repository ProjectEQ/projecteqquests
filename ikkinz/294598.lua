...
function event_spawn(e)
	...
	if (qglobals["vrexkill2"] ==nil) then	
		local random_class=pick_class();
		eq.set_global("vrexkill2", tostring(random_class), 3, "H6");
...
function event_death_complete(e)
	local qglobals = eq.get_qglobals(e.self);
	if (qglobals["vrexkill2"] == tostring(e.other:GetClass())) then
