...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 62811})) then
		...
		e.other:SummonItem(62605);
		e.other:SummonItem(62657,6);
	elseif(item_lib.check_turn_in(e.trade, {item1 = 62615})) then
		...
		e.other:SummonItem(62605);
		e.other:SummonItem(62611);
		e.other:SummonItem(62612);
		e.other:SummonItem(62613);
		e.other:SummonItem(62614);
