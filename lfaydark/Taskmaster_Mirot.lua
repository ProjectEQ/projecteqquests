...
function event_say(e)
	...
	if(qglobals["cleric_epic"] >= "4" and e.message:findi("hail")) then
		...
		e.self:GMMove(3435.6,-79.3,-2.8,250);
		eq.depop_all(57152);
		eq.spawn2(57153,0,0,3430,-13.5,-1.9,90);
		eq.spawn2(57153,0,0, 3425,-25 ,-1.9,330);
		eq.spawn2(57153,0,0, 3430,-33.5 ,-1.9,0);
		eq.spawn2(57153,0,0, 3443,-25.5 ,-1.9,180);
		eq.spawn2(57153,0,0, 3440,-33.5 ,-1.9,270);
		eq.spawn2(57153,0,0, 3443,-15.5 ,-1.9,180);					
...
function event_spawn(e)
		eq.spawn2(57152,0,0,3430,-13.5,-1.9,90);
		eq.spawn2(57152,0,0, 3425,-25 ,-1.9,330);
		eq.spawn2(57152,0,0, 3430,-33.5 ,-1.9,0);
		eq.spawn2(57152,0,0, 3443,-25.5 ,-1.9,180);
		eq.spawn2(57152,0,0, 3440,-33.5 ,-1.9,270);
		eq.spawn2(57152,0,0, 3443,-15.5 ,-1.9,180);
end

function event_signal(e)
	if (e.signal == 1) then
		if (eq.get_entity_list():IsMobSpawnedByNpcTypeID(57153) == false) then
			eq.spawn2(57151,0,0,3420,-33.5,-1.9,41);	
			eq.spawn2(57154,0,0,3430,-13.5,-1.9,90);
			eq.spawn2(57154,0,0, 3425,-25 ,-1.9,330);
			eq.spawn2(57154,0,0, 3430,-33.5 ,-1.9,0);
			eq.spawn2(57155,0,0, 3443,-25.5 ,-1.9,180);
			eq.spawn2(57155,0,0, 3440,-33.5 ,-1.9,270);
			eq.spawn2(57155,0,0, 3443,-15.5 ,-1.9,180);		
		end
	end
	if (e.signal == 2) then
		eq.depop_with_timer();
