...
{	
	...
	{	
		...
		{ 
			...
			quest::spawn2(215487,0,0,-261,-700,113,442); # NPC: a menacing stormrider
			quest::spawn2(215487,0,0,-265,-705,112,446); # NPC: a menacing stormrider
			quest::spawn2(215487,0,0,-271,-709,111,440); # NPC: a menacing stormrider
			quest::spawn2(215487,0,0,-275,-713,110,443); # NPC: a menacing stormrider
			quest::spawn2(215487,0,0,-269,-692,113,446); # NPC: a menacing stormrider
			quest::spawn2(215487,0,0,-272,-695,112,441); # NPC: a menacing stormrider
			quest::spawn2(215487,0,0,-278,-699,111,438); # NPC: a menacing stormrider
			quest::spawn2(215487,0,0,-284,-702,111,440); # NPC: a menacing stormrider
