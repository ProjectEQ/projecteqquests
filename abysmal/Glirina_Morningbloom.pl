...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    if (quest::istaskactivityactive(500169,4)) { #Jewelcraft Collect Step 5
    ...
    elsif (quest::istaskactivityactive(500160,4)) { #Jewelcraft Freebie Step 5
      quest::emote("smiles broadly at you.");
      quest::say("You have been of great assistance to me. It would be improper for me to ask more of you. I will find others to do these tasks. I have learned much doing research while you have been helping me. Let me show you the method I have discovered for preparing the nihilite.");
  ...
  if ($text=~/work/i) {
    ...
    quest::taskselector(500160); #Jewelcraft Freebie
  }
  if ($text=~/many items/i) {
    if (quest::istaskactivityactive(500160,0)) { #Jewelcraft Freebie Step 1
    ...
    if(quest::istaskactivityactive(500160,1)) { #Jewelcraft Freebie Step 2
    ...
    if(quest::istaskactivityactive(500160,2)) {  #Jewelcraft Freebie Step 3
    ...
    if(quest::istaskactivityactive(500160,3)) { #Jewelcraft Freebie Step 4
