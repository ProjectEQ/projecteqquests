...
function event_spawn(e)
	...
	if (qglobals["vrexkill3"] ==nil) then	
		local random_class=pick_class();
		eq.set_global("vrexkill3", tostring(random_class), 3, "H6");
...
function event_death_complete(e)
	local qglobals = eq.get_qglobals(e.self);
	if (qglobals["vrexkill3"] == tostring(e.other:GetClass())) then
