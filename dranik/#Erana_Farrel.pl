sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 52909 =>1 )) {
	...
	quest::spawn2(336248,0,0,-1439,452,-38.3,211);
	quest::spawn2(336247,0,0,-1439,466.5,-38.3,197);
	quest::spawn2(336249,0,0,-1465,445,-38.3,202);
	quest::spawn2(336246,0,0,-1448,431,-38.3,207);
	quest::spawn2(336245,0,0,-1453,419,-39.9,216);
  }
