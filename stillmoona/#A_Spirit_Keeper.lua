function event_say(e)
	...
	elseif(e.message:findi("worthy")) then
			...
			eq.spawn2(338167,0,0,144,689,43.70,384);
			eq.spawn2(338167,0,0,164,700,43.70,384);
			eq.spawn2(338167,0,0,166,716,43.70,384);
			eq.spawn2(338167,0,0,153,732,43.70,384);
			eq.spawn2(338167,0,0,144,711,43.70,384);
			eq.depop();
	end
end
