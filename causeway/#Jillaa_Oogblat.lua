function event_say(e)
	...
	if(e.message:findi("hail") and qglobals["beast_epic"] == "18" and eq.get_entity_list():IsMobSpawnedByNpcTypeID(303092) == false) then
		...
		eq.spawn2(303092,0,0, 378.32,70.83 ,267.45 ,110 ); --#Bazu_Terror
		eq.spawn2(303093,0,0,410.5,62.8,262,128); --a_bazu_crusher (303093)
		eq.spawn2(303093,0,0,346,70.6,262,78); --a_bazu_crusher (303093)
		eq.spawn2(303093,0,0,361,112.6,262,84); --a_bazu_crusher (303093)
		eq.spawn2(303093,0,0,410,120,262,138); --a_bazu_crusher (303093)
