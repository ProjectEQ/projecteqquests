...
sub EVENT_ITEM {
	if(plugin::check_handin(\%itemcount, 2460 => 4)) {
  		quest::say("Excellent!  Here are your Gloves!  Would you like to get a [Bracer]?");
		quest::summonitem(2452);
  	}
  	elsif(plugin::check_handin(\%itemcount, 2476 => 4)) {
  		quest::say("Excellent! Here is your Bracer! Would you like to get some [Boots]?");
  		quest::summonitem(2453);
  	}
  	elsif(plugin::check_handin(\%itemcount, 2477 => 4)) {
  		quest::say("Excellent!  Here are your Boots!  Would you like to get some [Sleeves]?");
  		quest::summonitem(2454);
  	}
  	elsif(plugin::check_handin(\%itemcount, 2478 => 4)) {
  		quest::say("Excellent! Here are your Sleeves! Would you like to get a [Cap]?");
  		quest::summonitem(2455);
  	}
  	elsif(plugin::check_handin(\%itemcount, 2479 => 4)) {
  		quest::say("Excellent! Here is your Cap! Would you like to get some [Pants]?");
  		quest::summonitem(2456);
  	}
  	elsif(plugin::check_handin(\%itemcount, 2480 => 4)) {
  		quest::say("Excellent! Here are your Pants! Would you like to get a [Tunic]?");
  		quest::summonitem(2457);
  	}
  	elsif(plugin::check_handin(\%itemcount, 2481 => 4)) {
  		quest::say("Excellent! Here is your Tunic!");
  		quest::summonitem(2459);
  	}
  	else {
  		plugin::return_items(\%itemcount);
  		quest::say("I shall only reward you when you bring me four of the items I asked for!");
  	}
}
