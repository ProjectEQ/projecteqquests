...
if(plugin::check_handin(\%itemcount,13972=> 1)){
...
if(plugin::check_handin(\%itemcount,13974=> 1)){
...
if(plugin::check_handin(\%itemcount,13974=> 2)){
...
if(plugin::check_handin(\%itemcount,13974=> 3)){
quest::say("Oh good!  I see you have taught that nasty Nillipuss a thing or two!  Good.  But it seems to me that he has stolen more jumjum than this.  Perhaps he needs another lesson?");
}
if(plugin::check_handin(\%itemcount,13974=> 4)){
