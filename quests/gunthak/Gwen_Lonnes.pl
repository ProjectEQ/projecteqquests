...
sub EVENT_SAY { 
	...
	if (($text=~/other things/i) && ($GwenLonnesA == 1)){
...
sub EVENT_ITEM {
  ...
  elsif((plugin::check_handin(\%itemcount, 59058 => 1, 59059 => 1)) && ($GwenLonnesA == 1)){#A Jar of Broken Skull Clan Ink, A Dark Ore Amulet
