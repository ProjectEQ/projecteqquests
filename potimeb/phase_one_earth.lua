...
function event_timer(e)
	if(e.timer == "Phase1Earth") then
		...
		eq.spawn2(223106,0,0,70.3,1644.5,493.7,371); -- NPC: a_pile_of_living_rubble
		eq.spawn2(223106,0,0,70.3,1654.5,493.7,371); -- NPC: a_pile_of_living_rubble
		eq.spawn2(223106,0,0,70.3,1634.5,493.7,371); -- NPC: a_pile_of_living_rubble
