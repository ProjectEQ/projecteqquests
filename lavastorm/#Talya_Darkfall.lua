function event_say(e)
	...
	elseif(e.message:findi("war drakes")) then
		--You have been assigned the task 'War Drake Secrets'.
	...
	elseif(e.message:findi("lavaspinners")) then
