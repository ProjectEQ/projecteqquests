...
function event_say(e)
	...
	elseif (e.message:findi("rat steaks")) then
		...
		eq.popup("Tradeskills", "<br>To cook the rat steaks that Frizznik has requested, use the oven next to him.  Place the rat meat and the kobold cooking sauce into your inventory and then <c \"#00F0F0\">left click</c> the oven to open the <c \"#00A000\">Tradeskill Window</c>.  Then <c \"#00F0F0\">left click</c> the 'Search Recipes' button near the top of the window to display a list of recipes in the box below.  Scroll down until you see 'Rat Steaks' on the list and <c \"#00F0F0\">left click</c> on it.  Then click the <c \"#00F0F0\">Combine</c> button to cook the rat steak.<br><br><c \"#F07F00\">Click 'OK' to learn of a different way to cook a rat steak.</c>", 1);
	end
end
