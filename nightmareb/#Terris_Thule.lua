...
function event_hp(e)
 ...
 function event_timer(e)
	...
	elseif ( e.timer == "gargs" ) then
		eq.stop_timer("gargs");
		eq.spawn2(221013,0,0,-1954,99,202,191); --untargettable statue
		eq.spawn2(221013,0,0,-1748,91,202,330); --untargettable statue
		eq.spawn2(221013,0,0,-1736,-125,202,454); --untargettable statue
		eq.spawn2(221013,0,0,-1958,-104,202,67); --untargettable statue
	end
end
