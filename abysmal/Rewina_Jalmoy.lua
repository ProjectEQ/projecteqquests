...
function event_trade(e)
	...
	if qglobals["warrior_epic"] ~= nil and qglobals["warrior_epic"] >= "2" and item_lib.check_turn_in(e.trade, {item1 = 60295, item2 = 60296, item3 = 60297, item4 = 60298}) then -- Items: Decomposing Page 1,2,3 and Decomposing Cover
