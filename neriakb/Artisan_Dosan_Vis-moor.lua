-- Newer Cultural Tradeskill Armor Quest -- Dark Elf
...
function event_say(e)
	...
	if e.other:GetBaseRace() == e.self:GetBaseRace() then
		if e.message:findi("hail") then
			e.other:Message(MT.NPCQuestSay, "Artisan Dosan Vis`moor says, 'So "..e.other:GetCleanName() ..", the harsh light of the surface has finally driven you back to Neriak?  Or have you returned to replace that pitiful [armor] that hangs from your sunburned frame?'");
		elseif e.message:findi("armor") then
			e.other:Message(MT.NPCQuestSay, "Artisan Dosan Vis`moor says, 'That's what I thought.  Your current set looks like it fell from one of Innoruuk's zombies.  If you are interested in some more eloquent designs, I have acquired some armor patterns designed by one of Lanys T'Vyl personal artisans.  Never mind how I acquired them, what's important is that they can be yours, for a [price], of course.  Then again, if you're interested in something even more [valuable] I might be able to help you there as well.'");
		elseif e.message:findi("price") then
			e.other:Message(MT.NPCQuestSay, "Artisan Dosan Vis`moor says, 'Well, the patterns are all in my head. If I had the actual pattern book, I'd be a hunted elf right now. So if you bring me the ingredients to make two pattern books, I'll give the extra one to you. I will need a raw-hide belt for the covers, a low quality cat pelt for the pages, a cutthroat insignia ring for the book clasps, and a snake venom sac to grind down and make a salve which will protect and preserve the finished products. I have heard these items can be found in the Southern Desert of Ro and the Commanlands. Bring them to me and the extra book shall be yours.'");
		elseif e.message:findi("valuable") then
			e.other:Message(MT.NPCQuestSay, "Artisan Dosan Vis`moor says, 'It's my understanding that this armor can be adorned with symbols to increase its potential. If you'd be willing to do me a few favors, I might consider parting with the plans for these symbols. The more dangerous my errand, the more rewarding the symbol shall be.  I need to get some impressions from the body parts of certain of the lowly creatures outside Neriak.  Do not ask why, it is not for you to know.  You can do any of the tasks I have offered you.  Take this impression book and make impressions of certain parts of critters that you slay.  This magical book can make impression of objects with depth to them or just of the pattern on the surface of an object.'");
			eq.task_selector(task_array);
		end
	else
		e.other:Message(MT.NPCQuestSay, "Artisan Dosan Vis`moor says, 'Greetings, "..e.other:GetCleanName() ..".  I'm afraid I do not have time to talk at the moment.  Please leave me to my work.  If your looking for work yourself, I suggest you return to your home city and seek out your own kind.'");
	end
end
...
function event_trade(e)
	...
	if e.other:GetBaseRace() == e.self:GetBaseRace() then
		...
		if e.other:IsTaskActivityActive(5785,4) and item_lib.check_turn_in(e.trade, {item1 = 34997}) then -- Blessed Impression Book
			...
			e.other:QuestReward(e.self,{itemid = 38428}); -- Item: Blessed Book of Dark Elven Culture
		elseif e.other:IsTaskActivityActive(5788,4) and item_lib.check_turn_in(e.trade, {item1 = 34998}) then -- Revered Impression Book
			...
			e.other:QuestReward(e.self,{itemid = 38429}); -- Item: Revered Book of Dark Elven Culture
		elseif e.other:IsTaskActivityActive(5790,4) and item_lib.check_turn_in(e.trade, {item1 = 34999}) then -- Sacred Impression Book
			...
			e.other:QuestReward(e.self,{itemid = 38430}); -- Item: Sacred Book of Dark Elven Culture
		elseif e.other:IsTaskActivityActive(5791,4) and item_lib.check_turn_in(e.trade, {item1 = 35000}) then -- Eminent Impression Book
			...
			e.other:QuestReward(e.self,{itemid = 38431}); -- Item: Eminent Book of Dark Elven Culture
		-- Not Supported
		elseif e.other:IsTaskActivityActive(5792,4) and item_lib.check_turn_in(e.trade, {item1 = 35017}) then -- Exalted Impression Book
			...
			e.other:QuestReward(e.self,{itemid = 35747}); -- Item: Exalted Book of Dark Elven Culture
		elseif e.other:IsTaskActivityActive(5793,4) and item_lib.check_turn_in(e.trade, {item1 = 35018}) then -- Sublime Impression Book
			...
			e.other:QuestReward(e.self,{itemid = 35748}); -- Item: Sublime Book of Dark Elven Culture
		elseif e.other:IsTaskActivityActive(6955,4) and item_lib.check_turn_in(e.trade, {item1 = 88388}) then -- Venerable Impression Book
			...
			e.other:QuestReward(e.self,{itemid = 49963}); -- Item: Venerable Book of Dark Elven Culture
		elseif e.other:IsTaskActivityActive(7070,4) and item_lib.check_turn_in(e.trade, {item1 = 17835}) then -- Illustrious Impression Book
			...
			e.other:QuestReward(e.self,{itemid = 123415}); -- Item: Illustrious Book of Dark Elven Culture
		elseif e.other:IsTaskActivityActive(7071,4) and item_lib.check_turn_in(e.trade, {item1 = 54449}) then -- Numinous Impression Book
			...
			e.other:QuestReward(e.self,{itemid = 112549}); -- Item: Numinous Book of Dark Elven Culture
		elseif e.other:IsTaskActivityActive(7078,4) and item_lib.check_turn_in(e.trade, {item1 = 55727}) then -- Transcendent Impression Book
			...
			e.other:QuestReward(e.self,{itemid = 134598}); -- Item: Transcendent Book of Dark Elven Culture
		end
	end
