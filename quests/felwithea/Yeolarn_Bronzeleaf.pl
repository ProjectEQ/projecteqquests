...
quest::exp(250); 
quest::faction(43,15);
quest::faction(178,15);
quest::faction(8,15);

}

elsif (plugin::check_handin(\%itemcount, 10199 => 4)) { # Putrescent Hearts
...
elsif (plugin::check_handin(\%itemcount, 1571 =>1, 1599 => 1)) { # Powder of Unanimation, Disciple Symbol of Tunare
...
elsif (plugin::check_handin(\%itemcount,18780 => 1)) {
