...
quest::summonitem(5960);
 ...
 if (plugin::check_handin(\%itemcount, 5965 =>1 )) {
 ...
 quest::faction( 132,10 );  #once again placeholder faction for Jharin
