...
function event_say(e)
	...
	elseif(e.message:findi("visiting")) then
		...
		if not dz.valid then
			dz = e.other:CreateExpedition("fhalls", 0, 21600, "The Forgotten Halls", 1, 6)
			if dz.valid then
				dz:SetCompass("nedaria", -670.09, 1541.43, 93.78)
				dz:SetSafeReturn("nedaria", -648.00, 1559.00, 96.05, 0)
				dz:SetZoneInLocation(-74.00, -843.00, -11.87, 0)
