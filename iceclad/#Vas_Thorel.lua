...
function event_say(e)
	...
	elseif e.message:findi("Lantaric") then
		...
		eq.spawn2(110123, 0, 0, 8859.7,-4502.8,225.25,195); --#Noble_Oldencamp
		eq.spawn2(110128, 0, 0, 8859,-4525.8,230.25,195); --#Amilia_Verisue
		eq.spawn2(110127, 0, 0, 8859,-4550,230.25,195); --#Nihilist Xeegarn
		eq.spawn2(110126, 0, 0, 8859,-4475,230.25,195); --#Puella_Opalis
		eq.spawn2(110125, 0, 0, 8859,-4450,230.25,195); --##Locis_V`Sek
		eq.spawn2(110129, 0, 0, 8879,-4465,230,195); --#a_frost_giant_escort
		eq.spawn2(110129, 0, 0, 8879,-4525,230,195); --#a_frost_giant_escort
		eq.spawn2(110129, 0, 0, 8879,-4585,230,195); --#a_frost_giant_escort
		eq.spawn2(110130, 0, 0, 8879,-4495,230,195); --#a_frost_giant_warrior
		eq.spawn2(110130, 0, 0, 8879,-4555,230,195); --#a_frost_giant_warrior
		eq.spawn2(110130, 0, 0, 8879,-4435,230,195); --#a_frost_giant_warrior
		end
	end	
end
