function event_say(e)
	if(e.message:findi("hail")) then
		...
		eq.unique_spawn2(338404, 0, 0, 681, 650, 20, 258);
		eq.spawn2(338405, 0, 0, 669, 621, 20, 68);
		eq.spawn2(338405, 0, 0, 692, 617, 20, 466);
	end
end
...
function event_trade(e)
	...
	if (item_lib.check_turn_in(e.trade, {item1 = 36212})) then	-- Ancient Note
		...
		eq.unique_spawn2(338411, 0, 0, -232, 1006, 43, 229);
