...
function event_say(e)
	...
	if(e.message:findi("hail") and qglobals["cleric_epic"] == "1") then
		e.self:Say("Please don't hurt me! Oh, you aren't one of them. Are you here to ask about the [Wayfarers] that I spoke with?");
	elseif(e.message:findi("Wayfarers") and qglobals["cleric_epic"] == "1") then
	...
	elseif(e.message:findi("note") and qglobals["cleric_epic"] == "1") then
		...
		eq.spawn2(283102,0,0,-665.7,133.5,-121.3,78);  -- Spawns "A Kyv Runner" to the immediate right of Jomaj Kaiijin.
