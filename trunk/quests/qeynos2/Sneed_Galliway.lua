function event_say(e)
	...
	elseif(e.message:findi("problem")) then
		e.self:Say("Shhh.. Keep it down. It seems I have a little rodent problem in my store. A mangy rat keeps digging into my crates of rations. He looks as if he is diseased. If you help me by killing this pest, I will make it owrth your while. Bring me his head as proff it is done.");
