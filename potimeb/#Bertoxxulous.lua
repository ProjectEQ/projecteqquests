...
function event_hp(e)
    ...
    if (e.hp_event == 85) then
        ...
        eq.zone_emote("Blisters and festering sores covering Bertoxxulous's hide burst. A noxious ooze bleeds down his scarred flesh, strengthening his physical body.")
    ...
    elseif (e.hp_event == 40) then
        eq.modify_npc_stat("min_hit", "1145")
        eq.modify_npc_stat("max_hit", "2000")
        eq.zone_emote("Bertoxxulous falters, nearly imperceptibly.")
