...
function event_trade(e)
	...
	if (item_lib.check_turn_in(e.trade, {item1 = 18837})) then
		...
		e.other:Faction(255,2); -- Faction: Gem Choppers
		e.other:Faction(288,2); -- Faction: Merchants of Ak`Anon
		e.other:Faction(333,2); -- Faction: King Ak`Anon
		e.other:Faction(238,-2); -- Faction: Dark Reflection
		e.other:Faction(1604,-2); -- Faction: Clan Grikbar
		e.other:AddEXP(2000);
		e.other:Ding();
