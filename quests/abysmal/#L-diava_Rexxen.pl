sub EVENT_SAY {
  ...
  if ($text=~/frightful temple/i) {
  if (defined $qglobals{bic} && $qglobals{bic} == 16) {      
...
sub EVENT_ITEM {
if (defined $qglobals{bic} && $qglobals{bic} == 14) {
 if (plugin::check_handin(\%itemcount, 67555 =>1 )) {
...
if (defined $qglobals{bic} && $qglobals{bic} == 15) {
 if (plugin::check_handin(\%itemcount, 67556 =>1, 67703 =>1, 67557 =>1, 67558 =>1 )) {
...
if (defined $qglobals{bic} && $qglobals{bic} == 16) {
 if (plugin::check_handin(\%itemcount, 67561 =>1 )) {
...
if (defined $qglobals{bic} && $qglobals{bic} == 16) {
 if (plugin::check_handin(\%itemcount, 67562 =>1 )) {
