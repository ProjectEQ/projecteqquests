...
sub EVENT_HP {
  if($hpevent == 75) {
    quest::spawn2(295131,0,0,84,423,-410,168); # NPC: Rav_Gernkki
    quest::spawn2(295132,0,0,126,310,-422,464); # NPC: Rav_Marnkki
    quest::spawn2(295133,0,0,267,283,-410,248); # NPC: Rav_Karnkki
