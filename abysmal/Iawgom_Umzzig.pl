...
sub EVENT_WAYPOINT_ARRIVE {
	...
	if($wp == 48) {
		quest::signalwith(279043,5,1); # NPC: Stu_Girbnol
		quest::signalwith(279044,5,1); # NPC: Haon_McClure
		quest::signalwith(279045,5,1); # NPC: Devolnu_Solahpeka
		quest::signalwith(279046,5,1); # NPC: Barny_Magmilg
...
sub EVENT_SIGNAL {
	if($signal == 1) {
		...
		quest::signalwith(279044,1,15000); # NPC: Haon_McClure
	}
