function event_say(e)
	...
	elseif(e.message:findi("strong") and qglobals["beast_epic"] == "20" and eq.get_entity_list():IsMobSpawnedByNpcTypeID(301069) == false) then
		eq.spawn2(301069,0,0, 158,-321.4,-756.6,176); --#DDA
