sub EVENT_SPAWN {
  ...
  if ($boss1) {
    quest::signalwith(162227,162125,0); # NPC: #Emperor_Ssraeshza_
  }
  if ($boss2) {
    quest::signalwith(162189,162125,0); # NPC: #Blood_of_Ssraeshza
  }
  if ($boss3) {
    quest::signalwith(162064,162125,0); # NPC: #Ssraeshzian_Blood_Golem
  }
}