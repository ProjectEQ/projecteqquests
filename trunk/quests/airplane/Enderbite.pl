...
sub EVENT_SAY {
	...
	} elsif ($text=~/disillusion/i) {  #enchanter test of disillusion
	...
	} elsif ($text=~/memorization/i) { #enchanter test of memorization
	...
	} elsif ($text=~/incapacitation/i) { #enchanter test of incapacitation
