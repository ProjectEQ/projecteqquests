...
sub EVENT_SIGNAL {
  if($signal == 1) { # signal from #ikaav_ixvet_pox
    ...
    quest::signalwith(283050,2,10); # NPC: #Ikaav_Ixvet_Pox
    ...
    quest::spawn2(283154,0,0,-457,672,-97,312); # NPC: #Construct_of_War
    quest::spawn2(283154,0,0,-471,602,-97,64); # NPC: #Construct_of_War
    quest::spawn2(283154,0,0,-533,631,-97,480); # NPC: #Construct_of_War
    quest::spawn2(283154,0,0,-523,500,-97,112); # NPC: #Construct_of_War
    quest::spawn2(283154,0,0,-490,500,-97,416); # NPC: #Construct_of_War
    quest::spawn2(283154,0,0,-469,563,-97,64); # NPC: #Construct_of_War
  }
}
