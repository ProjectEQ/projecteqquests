...
function event_spawn(e)
	...
	eq.set_global("warrior_epic_korezna","1",0,"F");
end	

function event_trade(e)
	local item_lib = require("items");
	local qglobals = eq.get_qglobals(e.other);
	if(item_lib.check_turn_in(e.trade, {item1 = 13006, item2 = 13006, item3 = 13006, item4 = 13006}) and qglobals["warrior_epic_korezna"] == "1") then --4x Water Flask
		e.self:Say("That helps, but I'm still too hot! More... water... please!");
		eq.set_global("warrior_epic_korezna","2",0,"F");
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 13006, item2 = 13006, item3 = 13006}) and qglobals["warrior_epic_korezna"] == "2") then --3x Water Flask
		...
		eq.set_global("warrior_epic_korezna","3",5,"F");
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 60301, item2 = 60302}) and qglobals["warrior_epic_korezna"] == "3") then -- Blackfall Ore and Smelting Plans
