function event_say(e)
	...
	elseif(e.message:findi("I am a young steel warrior")) then
	...
	elseif(e.message:findi("I want to craft Helm")) then
	...
	elseif(e.message:findi("I want to craft Bracer")) then
	...
	elseif(e.message:findi("I want to craft Armguard")) then
	...
	elseif(e.message:findi("I want to craft Boot")) then
	...
	elseif(e.message:findi("I want to craft Greave")) then
	...
	elseif(e.message:findi("I want to craft Gauntlet")) then
	...
	elseif(e.message:findi("I want to craft Breastplate")) then
	...
	elseif(e.message:findi("What important mission")) then
