...
function event_enter(e)
	if(e.other:HasItem(18740) == true) then
		e.other:Message(15,"As you make your way into a small well-lit room, a robed figure turns to greet you. 'Hello there, friend. I am Lorme Tredore, Magician Guild Master. Should you wish to begin your training, read the note in your inventory and then hand it to me'");
	end
end
