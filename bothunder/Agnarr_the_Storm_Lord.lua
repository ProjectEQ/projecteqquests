...
eq.unique_spawn(209115, 0, 0, -1082, -1740,  2251,  127);
eq.set_timer('agnarrhelp', 1 * 1000);
eq.set_next_hp_event(75);
elseif (e.hp_event == 75) then
eq.unique_spawn(209104, 0, 0, -1082, -1740,  2251,  127);
eq.set_timer('agnarrhelp', 1 * 1000);
eq.set_next_hp_event(50);
elseif (e.hp_event == 50) then
eq.unique_spawn(209105, 0, 0, -1082, -1740,  2251,  127);
eq.set_timer('agnarrhelp', 1 * 1000);
eq.set_next_hp_event(25);
elseif (e.hp_event == 25) then
eq.unique_spawn(209106, 0, 0, -1082, -1740,  2251,  127);
eq.set_timer('agnarrhelp', 1 * 1000);
end
end
