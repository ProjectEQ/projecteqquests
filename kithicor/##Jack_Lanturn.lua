...
function start_event(e)
	...
	eq.depop_all(20274);
	eq.depop_all(20262);		
	eq.spawn2(20266,0,0,-151,976,7.5,215);
	eq.spawn2(20266,0,0,-161,976,7.5,215);
	eq.spawn2(20266,0,0,-131,976,7.5,215);
	eq.spawn2(20266,0,0,-121,976,7.5,215);
	eq.spawn2(20267,0,0,-151,986,7.5,215);
	eq.spawn2(20267,0,0,-161,986,7.5,215);
	eq.spawn2(20267,0,0,-131,986,7.5,215);
	eq.spawn2(20267,0,0,-121,986,7.5,215);
	eq.spawn2(20257,0,0,-141,976,7.5,215); --#Casper
...
function event_timer(e)
	...
	elseif(e.timer=="wave2") then
		eq.stop_timer("wave2");
		eq.spawn2(20269,0,0,-243,1500,-14,189.6);
		eq.spawn2(20269,0,0,-233,1500,-14,189.6);
		eq.spawn2(20269,0,0,-263,1500,-14,189.6);
		eq.spawn2(20269,0,0,-273,1500,-14,189.6);
		eq.spawn2(20268,0,0,-243,1510,-14,189.6);
		eq.spawn2(20268,0,0,-233,1510,-14,189.6);
		eq.spawn2(20268,0,0,-263,1510,-14,189.6);
		eq.spawn2(20268,0,0,-273,1510,-14,189.6);
		eq.spawn2(20256,0,0,-233,1500,-14,189.6); --#Captain_Scareyface
		eq.set_global("halloween_great_pumpkin","1",7,"H1");
	elseif(e.timer=="wave3") then
		eq.stop_timer("wave3");
		eq.spawn2(20265,0,0,-151,976,7.5,215);
		eq.spawn2(20265,0,0,-161,976,7.5,215);
		eq.spawn2(20265,0,0,-131,976,7.5,215);
		eq.spawn2(20265,0,0,-121,976,7.5,215);
		eq.spawn2(20264,0,0,-151,986,7.5,215);
		eq.spawn2(20264,0,0,-161,986,7.5,215);
		eq.spawn2(20264,0,0,-131,986,7.5,215);
		eq.spawn2(20264,0,0,-121,986,7.5,215);	
		eq.spawn2(20255,0,0,-141,976,7.5,215); --#Booberella
		eq.set_global("halloween_great_pumpkin","1",7,"H1");
	elseif(e.timer=="wave4") then
		eq.stop_timer("wave4");
		eq.spawn2(20272,0,0,-151,976,7.5,215);
		eq.spawn2(20272,0,0,-161,976,7.5,215);
		eq.spawn2(20272,0,0,-131,976,7.5,215);
		eq.spawn2(20272,0,0,-121,976,7.5,215);
		eq.spawn2(20273,0,0,-151,986,7.5,215);
		eq.spawn2(20273,0,0,-161,986,7.5,215);
		eq.spawn2(20273,0,0,-131,986,7.5,215);
		eq.spawn2(20273,0,0,-121,986,7.5,215);
		eq.spawn2(20261,0,0,-141,976,7.5,215); --#Solomon_Grundy
		eq.set_global("halloween_great_pumpkin","1",7,"H1");
	elseif(e.timer=="wave5") then
		eq.stop_timer("wave5");
		eq.spawn2(20270,0,0,-243,1500,-14,189.6);
		eq.spawn2(20270,0,0,-233,1500,-14,189.6);
		eq.spawn2(20270,0,0,-263,1500,-14,189.6);
		eq.spawn2(20270,0,0,-273,1500,-14,189.6);
		eq.spawn2(20271,0,0,-243,1510,-14,189.6);
		eq.spawn2(20271,0,0,-233,1510,-14,189.6);
		eq.spawn2(20271,0,0,-263,1510,-14,189.6);
		eq.spawn2(20271,0,0,-273,1510,-14,189.6);
		eq.spawn2(20258,0,0,-233,1500,-14,189.6); --#Count_Alucard
		eq.set_global("halloween_great_pumpkin","1",7,"H1");
	elseif(e.timer=="wave6") then
		eq.stop_timer("wave6");
		eq.spawn2(20274,0,0,-243,1500,-14,189.6);
		eq.spawn2(20274,0,0,-233,1500,-14,189.6);
		eq.spawn2(20274,0,0,-263,1500,-14,189.6);
		eq.spawn2(20274,0,0,-273,1500,-14,189.6);
		eq.spawn2(20274,0,0,-243,1510,-14,189.6);
		eq.spawn2(20274,0,0,-233,1510,-14,189.6);
		eq.spawn2(20274,0,0,-263,1510,-14,189.6);
		eq.spawn2(20274,0,0,-273,1510,-14,189.6);
		eq.spawn2(20262,0,0,-233,1500,-14,189.6); --#The_Great_Pumpkin
		eq.set_global("halloween_great_pumpkin","1",7,"H1");
