...
function event_enter(e)
	...
	if(qglobals["ranger_epic"] == "3" and qglobals["ranger_epic_dranik"] == nil and e.other:HasItem(62623) == true and eq.get_entity_list():IsMobSpawnedByNpcTypeID(336001) == false ) then
		...
		eq.spawn2(336002, 0, 0, -961.3,2308,-160,252);
		eq.spawn2(336001, 0, 0, -919.6,2308,-160,252);
		eq.spawn2(336230 ,0, 0, -904,2261,-160,488);
		eq.spawn2(336230 ,0, 0, -929,2251,-160,494);
		eq.spawn2(336230 ,0, 0, -972,2251,-160,30);
		eq.spawn2(336230 ,0, 0, -997,2276,-160,62);	
		eq.spawn2(336230 ,0, 0, -977,2158,-160,0);
		eq.spawn2(336230 ,0, 0, -941,2251,-160,30);
		eq.spawn2(336230 ,0, 0, -865,2179,-160,466);
	end
end
