...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 18862})) then
		if (fac <= 3) then
			...
			e.other:SummonItem(ChooseRandom(26022,26023,26024,26025)); -- Item(s): Spirit Talker's Headdress (26022), Paebala Warbone (26023), Chelaki Tail (26024), Cowl of Mortality (26025)
			e.other:Ding();
