...
sub EVENT_TIMER {
  if($timer == 1) {
   $entid1 = quest::spawn2(quest::ChooseRandom(284098,284107),0,0,-170,-884,3,114);
   $entid2 = quest::spawn2(quest::ChooseRandom(284098,284107),0,0,-167,-792,3,136);
   $entid3 = quest::spawn2(quest::ChooseRandom(284098,284107),0,0,-170,-884,3,114);
   $entid4 = quest::spawn2(quest::ChooseRandom(284098,284107),0,0,-167,-792,3,136);
