sub EVENT_SPAWN {
	...
	quest::me("A tremor rumbles through the halls of Drunder. Terror wells up inside you as you struggle to keep your footing.");
}
...
sub EVENT_TIMER {
	...
	if($timer eq "fakeRZadds") {
		...
		quest::spawn2(214130,193,0,978,-560,133.13,385.8); # NPC: A_Decorin_Elite
		quest::spawn2(214130,194,0,978,580,133.13,385.8); # NPC: A_Decorin_Elite
