...
sub EVENT_SAY {
    ...
    if ($text=~/hail/i) {
        ...
        plugin::NPCTell("Perfect! I have a unique talent - I can grant you the ability to shift your spirit, allowing you to pick up a different set of skills. You'll be as weak as 
                        ...
                        over to different aspects of your spirit. I can open up new [". quest::saylink("Classes",1) ."] for you to explore, but you'll need to do some [". quest::saylink("favors",1) .
                        "] for me, first.");
    } 
}