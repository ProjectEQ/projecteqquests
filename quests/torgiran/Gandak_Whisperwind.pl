...
sub EVENT_ITEM {
  ...
  if (defined($qglobals{Gandak}) && ($qglobals{Gandak} == 1) && plugin::check_handin(\%itemcount, 21989 => 1, 21990 => 1, 21991=> 1, 21992 => 1)) { #Insignia of Hatred, Insignia of Slaying, Insignia of the Blackblood, Insignia of Suffering
