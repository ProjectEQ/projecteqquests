...
function event_say(e)
	...
	if(e.other:Class() == "Warrior") then
		...
		elseif(e.message:findi("work")) then
			if (((e.other:HasItem(10910) and e.other:HasItem(10909)) or e.other:HasItem(10908)) or e.other:HasItem(66175)) or qglobals["warrior_pre"] == "6") then --Have 1.0 or have finished prequest
...
function event_trade(e)
	...
	local qglobals = eq.get_qglobals(e.other);
	if(qglobals["warrior_pre"] == "1" and item_lib.check_turn_in(e.trade, {item1 = 60285})) then --hand in Korbuk's Weapon Plans (dropped by The Diaku Overseer in PoTactics)
