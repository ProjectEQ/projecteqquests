...
sub EVENT_HP {
  ...
  if($hpevent == 90) {
    quest::spawn2(294616,0,0,816,125,-73,124);
    quest::spawn2(294616,0,0,761,118,-73,121);
    quest::spawn2(294616,0,0,744,46,-73,101);
    quest::spawn2(294616,0,0,852,73,-73,146);
