...
sub EVENT_TIMER {
  ...
  if ($count == 10) {
    ...
    quest::signal(155105,10); # NPC: Jharin_Hajka
    quest::signal(155140,10); # NPC: Dar_Khura_Aylin
    quest::signal(155139,10); # NPC: Khala_Dun_Gurish
    quest::signal(155108,10); # NPC: Ahjiq_Mumir
    quest::signal(155107,10); # NPC: Khala_Dun_Rorya
