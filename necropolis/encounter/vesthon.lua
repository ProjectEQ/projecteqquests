...
function event_encounter_load(e)
    ...
    eq.register_npc_event("vesthon", Event.spawn, 123189, MinionSpawn)
    ...
    eq.register_npc_event("vesthon", Event.death_complete, 123189, MinionDeath)
    ...
    eq.register_npc_event("vesthon", Event.timer, 123189, MinionTimer)
    ...
    eq.register_npc_event("vesthon", Event.signal, 123189, MinionSignal)
end
