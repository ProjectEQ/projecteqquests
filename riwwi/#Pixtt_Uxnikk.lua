...
function event_say(e)
	...
	elseif(e.message:findi("dare")) then
		if(eq.get_entity_list():IsMobSpawnedByNpcTypeID(282115) == true and eq.get_entity_list():IsMobSpawnedByNpcTypeID(282105) == false and e.other:GetRaidMemberCountInZone() >= TM_minimum_players) then
