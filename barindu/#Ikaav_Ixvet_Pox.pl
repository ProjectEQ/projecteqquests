sub EVENT_SIGNAL {
  if($signal == 1) { # signal from #Abena_Taifa
    ...
    quest::signalwith(283047,1,10); # NPC: Aneuk_Controller
    ...
    # signal the Aneuk Controller
    quest::signalwith(283047,3,1); # NPC: Aneuk_Controller
	# repop as Ikaaz_Ixvet_Pox??
    quest::depop_withtimer();
    quest::spawn2(283162,0,0,$x,$y,$z,$h); # NPC: Ikaav_Ixvet_Pox
  }
}
...
sub EVENT_DEATH_COMPLETE {
  ...
  quest::depop(283153);
  quest::spawn2(283048,0,0,-574,568,-98,336); # NPC: #Talwin`s_remains
}
