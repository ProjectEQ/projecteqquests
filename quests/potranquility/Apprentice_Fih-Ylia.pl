sub EVENT_SAY { 
if($text=~/Hail/i){
quest::say("Can I help you?  I'm just finishing up here. but I may be available to assist you if you return [" . quest::saylink("when you are done",0,"when I'm done") . "].");
}
if($text=~/when you/i){
quest::say("I'm not sure. but I do know that it won't be for a while yet. Are you here to assist with our [" . quest::saylink("purpose") . "]?");
}
if($text=~/purpose?/i){
