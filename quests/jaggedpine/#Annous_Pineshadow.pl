...
sub EVENT_SAY {
  ...
  if ($text=~/how long has it been?/i && $faction == 1) {
  ...
  if ($text=~/What sacred ways do you speak of/i && $faction == 1) {
  ...
  if ($text=~/I have faith in my heart/i && $faction == 1) {
  ...
  if ($text=~/I am willing to test my faith/i && $faction == 1) {
  ...
  if ($text=~/What is an Azure idol of karana/i && $faction == 1) {
  ...
  if ($text=~/I wish to prove myself worthy/i && $faction == 1 && $qglobals{galeweaver} == 1){
  ...
  if ($text=~/What is a dormant crystal sphere?/i && $qglobals{galeweaver} == 1) {
  ...
  if ($text=~/How is it unique to the rainkeeper?/i && $qglobals{galeweaver} == 1) {
  ...
  if ($text=~/What can you tell me of the Rainkeeper Writ?/i && $qglobals{galeweaver} == 1) {
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 8956 => 1) && $faction == 1){ #Idol of karana
    ...
    quest::faction(121,10);
    quest::faction(122,10);
    quest::faction(291,10);
    quest::setglobal("galeweaver",1,0,F);
   }
  if (plugin::check_handin(\%itemcount, 8964 => 1, 8963 => 1, 8962 => 1 ) && $qglobals{galeweaver} == 1){ # Writ, sphere, and scroll turn in
  ...
  if (plugin::check_handin(\%itemcount, 8966 => 1) && $qglobals{galeweaver} == 2){ #Turn in orb of the gale
