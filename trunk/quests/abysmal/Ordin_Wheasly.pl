sub EVENT_SAY {
  ...
  if (defined $qglobals{ordin} && $qglobals{ordin} == 1) {
  if ($text=~/assistance/i) {
     quest::summonitem(58214,20);
     quest::summonitem(58046,20);
    }
  }
  if (defined $qglobals{ordin} && $qglobals{ordin} == 2) {
  if ($text=~/assistance/i) {
     quest::summonitem(58046,20);
    quest::summonitem(58214,20);
  ...
  if (defined $qglobals{ordin} && $qglobals{ordin} == 3) {
  if ($text=~/assistance/i) {
     quest::summonitem(58046,20);
...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 58059 =>100 )) {
    quest::setglobal("ordin",1,0,"F");
  ...
  if (plugin::check_handin(\%itemcount, 58193 =>100 )) {
    quest::setglobal("ordin",2,0,"F");
  ...
  if (plugin::check_handin(\%itemcount, 58198 =>100 )) {
    quest::setglobal("ordin",3,0,"F");
  ...
  if (plugin::check_handin(\%itemcount, 58196 =>100 )) {
    ...
    quest::delglobal("ordin");
  }
  plugin::return_items(\%itemcount);
  $qglobals{ordin}=undef
}