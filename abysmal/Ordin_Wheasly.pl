...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    if (quest::istaskactivityactive(500167,4)) { #Baking Collect Step 5
    ...
    elsif (quest::istaskactivityactive(500157,4)) { #Baking Freebie Step 5
      quest::say("You have been a big help around the kitchen! I wouldn't feel right continuing to abuse your kindness.");
      quest::emote("glances around.");
  ...
  if ($text=~/assistance/i) {
    ...
    quest::taskselector(500157); #Baking Freebie
  }
  ...
  if ($text=~/further help/i) {
    if (quest::istaskactivityactive(500157,0)) { #Baking Freebie Step 1
      quest::summonitem(58045,20); #Hot Water
      quest::summonitem(58056,20); #Oatmeal
    }
    elsif (quest::istaskactivityactive(500157,1)) { #Baking Freebie Step 2
    ...
    elsif (quest::istaskactivityactive(500157,2)) { #Baking Freebie Step 3
    ...
    elsif (quest::istaskactivityactive(500157,3)) { #Baking Freebie Step 4
