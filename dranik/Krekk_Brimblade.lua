...
function event_trade(e)
	...
	local qglobals = eq.get_qglobals(e.other);
	if(item_lib.check_turn_in(e.trade, {item1 = 60320, item2 = 60306, item3 = 60303}) and qglobals["warrior_epic"] == "14") then --Blackfall Blade, Potion of Blackfall Spirit and Hilt of Eternal Power
