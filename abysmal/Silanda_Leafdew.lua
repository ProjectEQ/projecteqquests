...
function event_trade(e)
	...
	local qglobals = eq.get_qglobals(e.other)
	if item_lib.check_turn_in(e.trade, {item1 = 62846}) then --Item: Mind Crystal
	...
	elseif item_lib.check_turn_in(e.trade, {item1 = 62857}) then --Item: Cleansed Mind Crystal
	...
	elseif qglobals["druid_epic"] ~= nil and qglobals["druid_epic"] == "12" and item_lib.check_turn_in(e.trade, {item1 = 62885}) then -- Item: Synched Leather Bag
