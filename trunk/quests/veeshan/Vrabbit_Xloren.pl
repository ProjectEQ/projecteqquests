sub EVENT_SAY {
  if ($text=~/hail/i) {
  quest::say("It is amazing to find outlanders such as yourself this far into the Peak. What is your business here young one? Are you possibly here to [see Phara Dar]?");    
  }
