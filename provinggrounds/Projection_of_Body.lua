...
local compass = { "provinggrounds", 1090.82, -4861.0, -309.726 }
local safereturn = { "provinggrounds", 1094.75, -4879.25, -306.75, 0.0 }
local zonein = { 0.0, -37.0, -0.875, 0 }

local weaponry = {
  info = { "Proving Grounds: The Mastery of Weaponry", 2, 6 },
  dz = { "chambersb", 1, eq.seconds("1h"), compass = compass, safereturn = safereturn, zonein = zonein }
}

local endurance = {
  info = { "Proving Grounds: The Mastery of Endurance", 6, 54 },
  dz = { "chambersb", 2, eq.seconds("3h"), compass = compass, safereturn = safereturn, zonein = zonein }
}
...
function event_say(e)
  ...
  elseif (e.message:findi("weaponry")) then
    ...
    e.other:CreateExpedition(weaponry.dz, weaponry.info)
  elseif (e.message:findi("endurance")) then
    ...
    e.other:CreateExpedition(endurance.dz, endurance.info)
