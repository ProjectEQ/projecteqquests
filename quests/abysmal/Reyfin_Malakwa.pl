...
if (plugin::check_handin(\%itemcount, 59906 => 1)) { # Taelosian Geomancy Stone Jelki
...
if (plugin::check_handin(\%itemcount, 59975 => 1)) { # Taelosian Geomancy Stone Eril
...
if (plugin::check_handin(\%itemcount, 59974 => 1)) { # Taelosian Geomancy Stone Yiktu
