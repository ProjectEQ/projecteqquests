...
sub EVENT_TIMER {
  if ($timer == 1) {   #group fail
     quest::stoptimer(1);
     quest::movegrp(281,-1053,438,-16);  #need working move function 
     quest::depopall(281114);
     quest::depopall(281117);
     quest::depopall(281123);
     quest::depopall(281119);
     quest::ze(1,"Understand that the punishment for spying is death!  Kreshin Silentcog if now executed!  All Hail Pixtt Xictic Krvne!");
     $start_event = undef;
}
