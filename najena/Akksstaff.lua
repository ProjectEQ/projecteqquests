...
function event_say(e)
	...
	elseif (e.message:findi("bantil sent me") and qglobals["mage_epic"] ~= nil and qglobals["mage_epic"] >= "5") then
		e.self:Say("My, you are persistent aren't you? Well you have found more trouble than you expected, now haven't you? Prepare to witness the true power of a master of the elements!");
		eq.spawn2(44108,0,0,e.self:GetX(),e.self:GetY(),e.self:GetZ(),e.self:GetHeading()); -- NPC: Akksstaff`s Minion
	end
end

function event_trade(e)
	if (eq.handin({[28027] = 1, [28028] = 1, [28029] = 1, [28030] = 1})) then -- Items: Torn Page of Mastery Fire, Torn Page of Mastery Wind, Torn Page of Mastery Earth, Torn Page of Mastery Water
