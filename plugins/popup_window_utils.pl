#::: Author: Akkadius
#::: Description: If the second arguement is 2, the first arguement has to declare how many characters there are in the line you are presenting. And then it will push the 
#::: Usage: plugin::PWAutoCenter("Text to be centered in popup window", ([Send Character length to window? = 1] [Use AutoCenter based on given character length = 2]));
sub PWAutoCenter{
	$Cent = $_[0];
	$SendCharLength = $_[1];
	if($SendCharLength != 2){
...
#::: Author: Akkadius
#::: Description: Used to send a break int a popup window
#::: Usage: plugin::PWBreak()
sub PWBreak{
	return "&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;
...
#::: Author: Akkadius
#::: Description: Used to send an indent
#::: Usage: plugin::PWIndent()
sub PWIndent{
	return "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
}
...
#::: 	If no color is defined, thi	s script will output this link in the popup window:
...
sub PWColor{
	...
	if($ColorText eq ""){ return "<a href=\"http://www.computerhope.com/htmcolor.htm\">You have not inserted a color name, you can find them at this link</a>"; }
	else{ return "<c \"$PWColor{$ColorText}\">"; }
}
