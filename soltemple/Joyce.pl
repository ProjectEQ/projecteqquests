...
sub EVENT_ITEM {
  ...
  #bracelet
  if (quest::handin({10539 => 1, 10542 => 1, 10540 => 1, 10541 => 1})) { # Items: Rune of Clay, Rune of Clay, Rune of Clay, Rune of Clay
  ...
  #boots
  if (quest::handin({10543 => 1, 10026 => 1, 10544 => 1, 2363 => 1})) { # Items: Stone Marker, Cat's Eye Agate, Heart of Stone, Soiled Boots
  ...
  #robe
  if (quest::handin({2361 => 1, 2362 => 1, 15109 => 1, 2360 => 1})) { # Items: Fire Goblin Skin, Frost Goblin Skin, Spell: Elemental Armor, Twice-Woven Cloak
