...
function event_spawn(e)
	...
	if (qglobals["vrexkill4"] ==nil) then	
		local random_class=pick_class();
		eq.set_global("vrexkill4", tostring(random_class), 3, "H6");
...
function event_death_complete(e)
	local qglobals = eq.get_qglobals(e.self);
	if (qglobals["vrexkill4"] == tostring(e.other:GetClass())) then
