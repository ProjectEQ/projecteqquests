...
elseif(e.timer=="nukes") then
	...
	local get_client=eq.get_entity_list():GetRandomClient(e.self:GetX(),e.self:GetY(),e.self:GetZ(),2500);
...
if(eq.get_entity_list():GetNPCBySpawnID(294629) == false) then --#Malevolent_Priest_ (294629)
Instance_Win();
