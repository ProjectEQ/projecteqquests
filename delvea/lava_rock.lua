...
function event_death(e)
	...
	if (roll >= 50) then
    		eq.local_emote({e.self:GetX(), e.self:GetY(), e.self:GetZ()}, MT.Yellow, 70,"You hear a loud screech as something breaks free of the stone.");
		...
		if (not added_loot) then
			added_loot = true;
    			eq.local_emote({e.self:GetX(), e.self:GetY(), e.self:GetZ()}, MT.Yellow, 70,"You feel a blast of heat as you open the rock and see a dark stone inside.");
