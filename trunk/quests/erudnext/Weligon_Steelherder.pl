...
sub EVENT_ITEM {  
	...
	elsif (plugin::check_handin(\%itemcount, 13879 => 1)) { #Pearls of Odus Handin: full bag of pearls
	...
	elsif (plugin::check_handin(\%itemcount, 18835 => 1, 13838 => 1, 13839 => 1, 13840 => 1)) { #Bridge Quest Handin: 3 heads + sealed list
	...
	elsif (plugin::check_handin(\%itemcount, 18725 => 1)) { # Tattered Note
